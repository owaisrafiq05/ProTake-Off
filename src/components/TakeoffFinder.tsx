      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <div className="flex items-center justify-center mb-8">
            ...
            <h3 className="text-2xl font-bold text-gray-900">Advanced Takeoff Search</h3>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 border-gray-300 text-lg py-4 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all"
                />
              </div>
            </div>
                ...
                <SelectContent>
                  <SelectItem value="landscaping">
                    <div className="flex flex-col items-start">
                      ...
                      <span className="text-sm text-gray-500">Garden design & installation</span>
                    </div>
                  </SelectItem>
                  <SelectItem value="irrigation">
                    <div className="flex flex-col items-start">
                      <span className="font-medium">Irrigation</span>
                      <span className="text-sm text-gray-500">Sprinkler & watering systems</span>
                    </div>
                  </SelectItem>
                  <SelectItem value="bundle">
                    <div className="flex flex-col items-start">
                      <span className="font-medium">Bundle</span>
                      <span className="text-sm text-gray-500">Combined landscaping & irrigation</span>
                    </div>
                  </SelectItem>
                </SelectContent>
              </Select>
                ...
                <SelectContent>
                  <SelectItem value="25">
                    <div className="flex flex-col items-start">
                      ...
                      <span className="text-sm text-gray-500">Local contractors</span>
                    </div>
                  </SelectItem>
                  <SelectItem value="100">
                    <div className="flex flex-col items-start">
                      <span className="font-medium">100 miles</span>
                      <span className="text-sm text-gray-500">Regional contractors</span>
                    </div>
                  </SelectItem>
                  <SelectItem value="150">
                    <div className="flex flex-col items-start">
                      <span className="font-medium">150+ miles</span>
                      <span className="text-sm text-gray-500">Extended search area</span>
                    </div>
                  </SelectItem>
                  <SelectItem value="all">
                    <div className="flex flex-col items-start">
                      <span className="font-medium">All</span>
                      <span className="text-sm text-gray-500">Nationwide search</span>
                    </div>
                  </SelectItem>
                </SelectContent>
              </Select>
                ...
                <SelectContent>
                  <SelectItem value="small">
                    <div className="flex flex-col items-start">
                      ...
                      <span className="text-sm text-gray-500">$50K - $150K</span>
                    </div>
                  </SelectItem>
                  <SelectItem value="medium">
                    <div className="flex flex-col items-start">
                      <span className="font-medium">Medium Sized</span>
                      <span className="text-sm text-gray-500">$150K - $300K</span>
                    </div>
                  </SelectItem>
                  ...
                  <SelectItem value="all">
                    <div className="flex flex-col items-start">
                      <span className="font-medium">All</span>
                      <span className="text-sm text-gray-500">Any project size</span>
                    </div>
                  </SelectItem>
                </SelectContent>
              </Select>
          ...
          <div className="mt-8">
            <Button
              type="submit"
              className="w-full bg-green-600 hover:bg-green-700 text-white py-4 text-lg font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105 group"
            >
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            <p className="text-sm text-gray-500">
              <span className="font-medium text-green-600">500+</span> contractors trust Protakeoffs.ai for their
              estimates
            </p>
          </div>
        </form>
