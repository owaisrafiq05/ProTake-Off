      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Why Choose <span className="text-brand-600">Protakeoffs.ai</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {benefits.map((benefit, index) => {
            ...
            return (
              <div
                key={index}
                className="group bg-white rounded-2xl p-8 shadow-sm border-2 border-gray-200 hover:border-brand-300 hover:shadow-xl transition-all duration-300 hover:scale-105"
              >
                {/* Icon and Stat */}
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="text-right">
                    <div className="text-sm font-bold text-brand-600">{benefit.stat}</div>
                  </div>
                </div>
        ...
        <div className="text-center mt-16">
          <div className="inline-flex items-center bg-brand-50 text-brand-700 px-6 py-3 rounded-full text-lg font-medium border border-brand-200">
