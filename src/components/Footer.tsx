...
const Footer: React.FC = () => {
  const handleLinkClick = (href: string, isRoute: boolean = false) => {
    console.log('Footer link clicked:', href, 'isRoute:', isRoute);
    // For debugging purposes
  };

  return (
    <footer className="relative bg-white border-t border-gray-200 overflow-hidden z-10">
      {/* Background Pattern */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 z-20">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center space-x-3 text-gray-600 hover:text-gray-900 transition-colors">
                ...
                <a 
                  href="mailto:hello@protakeoffs.ai" 
                  className="font-medium hover:text-brand-600 transition-colors cursor-pointer min-h-[44px] min-w-[44px] flex items-center relative z-10 footer-link"
                  aria-label="Send email to hello@protakeoffs.ai"
                  onClick={() => handleLinkClick('mailto:hello@protakeoffs.ai')}
                  role="button"
                  tabIndex={0}
                >
                  hello@protakeoffs.ai
                </a>
              </div>
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="w-12 h-12 bg-gray-100 hover:bg-brand-600 rounded-lg flex items-center justify-center text-gray-600 hover:text-white transition-all duration-300 transform hover:scale-110 group min-h-[48px] min-w-[48px] touch-manipulation relative z-10 footer-link"
              ...
              {[
                ...
                isRoute ? (
                  <Link
                    key={label}
                    to={href}
                    className="block text-gray-700 hover:text-brand-600 font-medium transition-colors duration-200 flex items-center group min-h-[44px] min-w-[44px] touch-manipulation py-2 relative z-10 footer-link"
                    onClick={() => handleLinkClick(href, true)}
                    role="button"
                    tabIndex={0}
                  >
                  ...
                  <a
                    ...
                    href={href}
                    className="block text-gray-700 hover:text-brand-600 font-medium transition-colors duration-200 flex items-center group min-h-[44px] min-w-[44px] touch-manipulation py-2 relative z-10 footer-link"
                    onClick={() => handleLinkClick(href, false)}
                    role="button"
                    tabIndex={0}
                  >
                    <ArrowRight className="h-4 w-4 mr-2 opacity-0 group-hover:opacity-100 transform -translate-x-2 group-hover:translate-x-0 transition-all duration-200 text-brand-600" />
        ...
        {/* Bottom Section */}
        <div className="border-t border-gray-200 mt-12 pt-8 relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex flex-row space-x-6 sm:flex-row md:space-y-2 sm:space-x-6 text-sm">
              ...
              <Link 
                to="/terms-of-service" 
                className="text-gray-600 hover:text-brand-600 font-medium transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center sm:justify-start touch-manipulation relative z-10 footer-link"
                onClick={() => handleLinkClick('/terms-of-service', true)}
                role="button"
                tabIndex={0}
              >
                Terms of Service
              ...
              <Link 
                to="/cookie-policy" 
                className="text-gray-600 hover:text-brand-600 font-medium transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center sm:justify-start touch-manipulation relative z-10 footer-link"
                onClick={() => handleLinkClick('/cookie-policy', true)}
                role="button"
                tabIndex={0}
              >
                Cookie Policy
      ...
      {/* Decorative Elements */}
      <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl from-brand-100/30 to-transparent rounded-full blur-3xl pointer-events-none"></div>
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-tr from-brand-50/50 to-transparent rounded-full blur-3xl pointer-events-none"></div>
    </footer>
  )
}
